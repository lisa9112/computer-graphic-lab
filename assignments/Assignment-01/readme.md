...
* Window title is set to **"Sadia Akter Liza"**
* Background color is **cyan**
* Pressing the **`L` key** closes the window
...
1. Clone this repository:
   ...
   ```bash
   https://github.com/lisa9112/computer-graphic-lab
   ```
2. Open the project folder in **VS Code**
3. Compile and run the program using your compiler
4. A cyan window titled **"Sadia Akter Liza"** will appear
5. Press **L** to close the window
